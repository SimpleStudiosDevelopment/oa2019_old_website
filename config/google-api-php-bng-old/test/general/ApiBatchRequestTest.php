...
require_once '../../../google-api-php-client/test/general/BaseTest.php';
require_once '../../../google-api-php-client/test/src/contrib/Google_PlusService.php';
require_once '../../../google-api-php-client/test/src/service/Google_BatchRequest.php';
